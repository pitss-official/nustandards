                        ...
                        <div class="card-body">
                            ...
                            <div id="visitfromworld" style="width:100%!important; height:415px">
                                <div class="jvectormap-container" style="background-color: rgb(255, 255, 255);">
                                    <svg width="607.328" height="415">
                                        <defs></defs>
                                        <g transform="scale(0.6748088888888889) translate(0, 87.14131219735233)">
                                            <path
                                        ...
                                        <g></g>
                                        <g>
                                            <circle data-index="0" cx="415.86269046134885" cy="215.04768361876145"
                                                    fill="#26c6da" stroke="#000" fill-opacity="1" stroke-width="0"
                                                    stroke-opacity="1" r="8"
                                                    class="jvectormap-marker jvectormap-element"></circle>
                                            <circle data-index="1" cx="539.2136608364763" cy="308.89801052095015"
                                                    fill="#02b0c3" stroke="#000" fill-opacity="1" stroke-width="0"
                                                    stroke-opacity="1" r="8"
                                                    class="jvectormap-marker jvectormap-element"></circle>
                                            <circle data-index="2" cx="82.29125125924064" cy="185.9957720229258"
                                                    fill="#11a0f8" stroke="#000" fill-opacity="1" stroke-width="0"
                                                    stroke-opacity="1" r="8"
                                                    class="jvectormap-marker jvectormap-element"></circle>
                                            <circle data-index="3" cx="278.3010124032787" cy="146.47936109894525"
                                                    fill="#745af2" stroke="#000" fill-opacity="1" stroke-width="0"
                                                    stroke-opacity="1" r="8"
                                                    class="jvectormap-marker jvectormap-element"></circle>
                                            <circle data-index="4" cx="377.4549157130387" cy="207.56361310083474"
                                                    fill="#ffbc34" stroke="#000" fill-opacity="1" stroke-width="0"
                                                    stroke-opacity="1" r="8"
                                                    class="jvectormap-marker jvectormap-element"></circle>
                                        </g>
                                        <g></g>
