...
<head>
    ...
    <title>NuStandards - Got Skill, Get Certified</title>
...
<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{@asset('/images/fullLogo.png')}}" width="160">
        <img class="navbar-brand-minimized" src="{{@asset('/images/logos.png')}}" width="30">
    </a>
...
<footer class="app-footer">
    <div>
        <span>NuStandards &copy; {{date("Y")}} - </span>
